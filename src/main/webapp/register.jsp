    ...
    <div class="container py-xl-5 py-sm-3">
        ...
        <section class="typo-section py-4 border-top border-bottom">
          ...
          <form action="doregister.html" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="男" checked onclick="changegender(this.value)">
                            <label class="form-check-label" for="gridRadios1">
                                男
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="女" onclick="changegender(this.value)">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" id="handin">提交</button>
                </div>
            </div>
        </form>
            <!--// form2 -->
